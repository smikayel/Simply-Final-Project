/*
  ...
  - A unique constraint covering the columns `[scheduleId,time]` on the table `ScheduleSubject` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX `ScheduleSubject_scheduleId_time_key` ON `ScheduleSubject`(`scheduleId`, `time`);
